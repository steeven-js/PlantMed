        ...
        <View style={[styles.mainWrapper, { backgroundColor: COLORS.primary }]}>
            <Animatable.View animation="fadeInUp" delay={100}>
                ...
                <ScrollView
                    ...
                    {/* Last updated date */}
                    <Text style={[styles.lastUpdateDate, { color: COLORS.accent }]}>
                    ...
                    <View style={styles.policyTitleWrapper}>
                        ...
                        />
                        <Text style={[styles.policyTitle, { color: COLORS.textHighContrast }]}>
                            Policy details
                        </Text>
                    </View>

                    {/* Policy details */}
                    <Text style={[styles.policyDetails, { color: COLORS.textLowContrast }]}>
                        ...
                        website
                        <Text style={{ color: COLORS.accent }}> www.plantmart.com </Text>, its
